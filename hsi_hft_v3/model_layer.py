...
class ResidualCombine(nn.Module):
    ...
    架构：
    1. 白盒代理：线性映射白盒特征到logit (可解释基线)
    2. 黑盒修正：线性映射深度因子到delta logit
    3. 残差相加：final_logit = base_logit + delta_logit
    """
